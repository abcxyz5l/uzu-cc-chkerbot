...
def check_card(card_data, fake_data):
    ...
    try:
        ...
        # Step 1: Get CSRF token and auth token
        headers = {
        ...
        res1 = s.post('https://api.betterworld.org/v1/user-payments/setup-intents', 
                      cookies=s.cookies, headers=headers, data=data)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        '⚠️ Make sure your file format is correct!'
    )
...
async def txt_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        for line in lines:
            ...
            # Send result
            await update.message.reply_text(f'[{checked}/{total_cards}] {result}')
